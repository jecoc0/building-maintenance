      ...
      <div className="card mb-3">
        <div className="row no-gutters">
          <div className="col-md-4">
            <img src={project.FacilityImage} className="card-img" alt="..." />
          </div>
          <div className="col-md-8">
            <div className="card-body">
              <h5 className="card-title">{project.FacilityName}</h5>
              <a
              ...
              <p>{project.FacilityDescription}</p>
                ...
                <div className="modal-body">
                  ...
                  >
                    <div className="form-row">
                      ...
                      <div className="form-group">
                        <label for="inputFacility">Facility Name</label>
                        <input
                          type="text"
                          className="form-control"
                          id="inputFacility"
                          placeholder="Government Facility"
                          value={name}
